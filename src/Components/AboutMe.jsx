...
const AboutMe = () => {
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="w-full h-[100vh] overflow-auto py-4 md:py-8 px-4 md:px-16 border border-gray-300 rounded-lg bg-white shadow-lg">
                ...
                <div className="mb-4 md:mb-6">
                    ...
                    <ul className="list-disc list-inside text-gray-700 mb-3 md:mb-4 text-base md:text-lg">
                        <li>Networks</li>
                ...
                <div className="mb-4 md:mb-6">
                    ...
                    <p className="text-gray-700 mb-3 md:mb-4 text-base md:text-lg">My research primarily focuses on:</p>
                    <ul className="list-disc list-inside text-gray-700 mb-3 md:mb-4 text-base md:text-lg">
